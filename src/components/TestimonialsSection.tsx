...
const testimonials = [
  ...
  },
  {
    name: "Lenice Pinto",
    initials: "LP",
    avatar: lenicePintoAvatar,
    text: "O trabalho da equipe muito importante e eficaz, meu marido fez o tratamento com grandes progressos. Sou muito grata a toda equipe. Parabéns e sucesso!",
  },
  {
